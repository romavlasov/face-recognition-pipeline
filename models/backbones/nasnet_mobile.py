...
class NASNetAMobile(nn.Module):
    ...
    def __init__(self, out_features=256, stem_filters=32, penultimate_filters=1056, filters_multiplier=2):
        ...
        self.conv0.add_module('bn0', nn.BatchNorm2d(3))
        self.conv0.add_module('conv', nn.Conv2d(in_channels=3, out_channels=self.stem_filters, kernel_size=3, padding=1, stride=1,
                                                bias=False))
        ...
        self.relu = nn.ReLU()
        self.pool = nn.Conv2d(self.penultimate_filters, self.penultimate_filters, 7,
                                 groups=self.penultimate_filters, bias=False)
        self.bn = nn.BatchNorm2d(self.penultimate_filters)
        self.linear = nn.Conv2d(self.penultimate_filters, out_features, 1, stride=1, padding=0, bias=False)
